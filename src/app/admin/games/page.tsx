...
export default function AdminGamesPage() {
    ...
    const handleDelete = async (gameId: string, gameName: string) => {
        ...
        if (result.success) {
            toast({
                title: "Game Deleted",
                description: `"${gameName}" has been successfully deleted.`,
            });
        } else {
            toast({
                title: "Error",
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        ...
                                                        <AlertDialogDescription>
                                                            This action cannot be undone. This will permanently delete the game category "{game.name}".
                                                        </AlertDialogDescription>
                                                        </AlertDialogHeader>
                                                        <AlertDialogFooter>
                                                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                                                        <AlertDialogAction onClick={() => handleDelete(game.id, game.name)}>Delete</AlertDialogAction>
                                                        </AlertDialogFooter>
                                                    </AlertDialogContent>
                                                </AlertDialog>
                                            </DropdownMenuContent>
