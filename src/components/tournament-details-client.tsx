...
export default function TournamentDetailsClient({ tournament: initialTournament }: { tournament: Tournament }) {
  const { user } = useAuth();
  ...
  if (!tournament) {
    return null; // The parent server component will handle not found.
  }
