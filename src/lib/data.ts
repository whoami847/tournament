...
export const mockTournaments: Tournament[] = [
  ...
  {
    id: 'valorant-challengers-sea',
    name: 'Valorant Challengers SEA',
    game: 'Valorant',
    ...
    entryFee: 50,
    prizePool: '150,000',
    rules: 'Group stage followed by double-elimination playoffs. Standard VCT ruleset. All participants must adhere to the Riot Games code of conduct.',
    status: 'upcoming',
    image: 'https://placehold.co/600x400.png',
