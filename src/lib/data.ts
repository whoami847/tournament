...
const teams = [
  ...
  { id: 't9', name: 'Crimson Crusaders', avatar: 'https://placehold.co/40x40.png' },
  { id: 't10', name: 'Azure Avengers', avatar: 'https://placehold.co/40x40.png' },
  { id: 't11', name: 'Golden Guardians', avatar: 'https://placehold.co/40x40.png' },
  { id: 't12', name: 'Shadow Strikers', avatar: 'https://placehold.co/40x40.png' },
];
...
export const mockTournaments: Tournament[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    game: 'Free Fire',
    startDate: '2024-08-01T18:00:00',
    teamsCount: 8,
    maxTeams: 16,
    entryFee: 5,
    prizePool: '2,000',
    rules: 'Fast-paced 4v4 Clash Squad action. Single elimination.',
    status: 'upcoming',
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'team action',
    participants: teams.slice(0,8),
    format: 'CS_SQUAD',
    bracket: [],
  },
  {
    ...
    name: 'Free Fire Lone Wolf Challenge',
    game: 'Free Fire',
    ...
    entryFee: 0,
    prizePool: '500',
    rules: '1v1 duels. Prove you are the best. Single elimination.',
    status: 'upcoming',
    image: 'https://placehold.co/600x400.png',
    ...
    game: 'Free Fire',
    startDate: '2024-08-15T20:00:00',
    teamsCount: 16,
    maxTeams: 32,
    entryFee: 0,
    prizePool: '1,000',
    rules: 'Fast paced 2v2 action. Lone Wolf style.',
    status: 'upcoming',
    image: 'https://placehold.co/600x400.png',
  ...
  {
    id: 'cs-duo-challenge',
    name: 'Clash Squad Duo Challenge',
    game: 'Free Fire',
    startDate: '2024-08-12T18:00:00',
    teamsCount: 16,
    maxTeams: 32,
    entryFee: 5,
    prizePool: '1,500',
    rules: 'Team up with a friend for this 2v2 CS tournament.',
    status: 'upcoming',
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'two players action',
  ...
  },
  {
    ...
    game: 'PUBG',
    startDate: '2024-08-10T14:00:00',
    teamsCount: 32,
    maxTeams: 64,
    entryFee: 10,
    prizePool: '2,000',
    rules: 'Prove your skill in this BR solo tournament.',
    status: 'upcoming',
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'lone survivor battle',
